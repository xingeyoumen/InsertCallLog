...
class IconLabelTextView : AppCompatTextView {
    ...
    private fun xp2px(context: Context, f: Float, unit: Int): Int {
        val displayMetrics = context.resources.displayMetrics
        return TypedValue.applyDimension(unit, f, displayMetrics).toInt()
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas?.let { canvas ->
            ...
            val availableWidth = width - paddingLeft - paddingRight - dp2px(context,30f)
